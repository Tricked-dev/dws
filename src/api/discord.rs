...
use crate::{app_state::AppState, bail, commands::handle_command, config::CONFIG, error::Result};
...
pub async fn handle_request(
    ...
    static VERIFIER: Lazy<Verifier> = Lazy::new(|| Verifier::new(&CONFIG.discord_public_key));
